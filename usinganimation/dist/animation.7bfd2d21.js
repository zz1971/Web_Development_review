...
function animate(_a) {
  var from = _a.from,
      ...
      options = (0, _tslib.__rest)(_a, ["from", "to", "autoplay", "driver", "elapsed", "repeat", "repeatType", "repeatDelay", "onPlay", "onStop", "onComplete", "onRepeat", "onUpdate"]);
  var driverControls;
  var repeatCount = 0;
  ...
  var animation = new Animator((0, _tslib.__assign)((0, _tslib.__assign)({}, options), {
    from: from,
    to: to
  }));
...
function inertia(_a) {
  ...
  return {
    stop: function () {
      ...
      return (_a = currentAnimation) === null || _a === void 0 ? void 0 : _a.stop();
    }
  };
}
...
exports.steps = steps;
},{"tslib":"node_modules/tslib/tslib.es6.js","style-value-types":"node_modules/style-value-types/dist/style-value-types.es.js","hey-listen":"node_modules/hey-listen/dist/hey-listen.es.js","framesync":"node_modules/framesync/dist/framesync.es.js"}],"animation.js":[function(require,module,exports) {
var popmotion = require('popmotion'); // const { styler, spring, listen, pointer, value } = window.popmotion;
...
var styler = popmotion.styler,
    ...
    value = popmotion.value; //const spring = window.popmotion.spring;   // do the same thing with all the other in braces 
...
listen(document, 'mouseup touchend').start(function () {
  //() => it's a newer way of writing function=>  function()
  spring({
    from: ballXY.get(),
